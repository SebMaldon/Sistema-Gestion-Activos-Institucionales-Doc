...
- **Consultas (Queries):**
  ...
  - `GET_USUARIOS`: Consulta general del directorio institucional (solicitada con `first: 20000`) para cargar en memoria el listado completo de personal activo y alimentar los buscadores instantáneos de responsable y solicitante.
